            ...
            if (target != null)
            {
                ...
                if (!GameStates.IsProceeding)
                {
                    _ = new LateTask(() =>
                    {
                        ...
                        _ = new LateTask(() => { Utils.SendMessage(string.Format(GetString("GuessKill"), Name), 255, CustomRoles.NiceGuesser.GetColoredTextByRole(GetString("GuessKillTitle")), true); }, 0.6f, "Guess Msg");
