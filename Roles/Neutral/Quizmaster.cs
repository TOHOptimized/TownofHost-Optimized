...
internal class Quizmaster : RoleBase
{
    ...
    public override string GetMark(PlayerControl seer, PlayerControl target = null, bool isForMeeting = false)
        => (!isForMeeting && seer.PlayerId != target.PlayerId && MarkedPlayer == target.PlayerId) ? CustomRoles.Quizmaster.GetColoredTextByRole(" ?!") : string.Empty;


    public override string GetMarkOthers(PlayerControl seer, PlayerControl target, bool isForMeeting = false)
            => (isForMeeting && MarkedPlayer == target.PlayerId) ? CustomRoles.Quizmaster.GetColoredTextByRole(" ?!") : string.Empty;
